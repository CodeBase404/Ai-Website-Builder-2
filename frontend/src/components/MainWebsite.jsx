...
import { ArrowRight, Code, Palette, Zap, Star, Users, Globe, Rocket } from 'lucide-react';
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto animate-slide-up">
            <h2 className="text-6xl md:text-7xl font-bold text-white mb-6">
              We Build
              <span className="block bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient pb-5 ">
                Digital Dreams
              </span>
            </h2>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { icon: <Globe className="w-8 h-8" />, number: "1000+", label: "Projects Completed" },
